...
def handle_message(event):
    ...
    if event.message.text == "Help":
        ...
        line_bot_api.reply_message(event.reply_token, AudioSendMessage(original_content_url='https://dl.dropboxusercontent.com/s/yro6rm2h1rk2zob/%E9%9B%BB%E8%A9%B11%E6%B5%B7%E9%99%B8.m4a', duration=22000))
