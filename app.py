...
def handle_message(event):
    ...
    if event.message.text == "Help":
        ...
        line_bot_api.reply_message(event.reply_token, AudioSendMessage(original_content_url='https://drive.google.com/drive/u/0/folders/1aAAbZDr2--FGr6zsEilbrL7K1Qx8Fh8D', duration=13000))
