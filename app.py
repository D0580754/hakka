...
def handle_message(event):
    ...
    if event.message.text == "Help":
        ...
        line_bot_api.reply_message(event.reply_token, AudioSendMessage(original_content_url='https://www.dropbox.com/home/audio?preview=abafcb0e-e190-ce77-6964-625a915d20fc+(online-audio-converter.com).m4a', duration=13800))
        ...
        #line_bot_api.reply_message(event.reply_token, AudioSendMessage(original_content_url='https://example.com/original.m4a', duration=60000))
