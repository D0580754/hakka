...
def handle_message(event):
    ...
    if event.message.text == "Help":
        ...
        line_bot_api.push_message(uid, AudioSendMessage('https://dl.dropboxusercontent.com/s/wr2r5hjjetuxd5s/abafcb0e-e190-ce77-6964-625a915d20fc%20%28online-audio-converter.com%29.m4a', duration=13800))
        line_bot_api.reply_message(event.reply_token, AudioSendMessage(original_content_url='https://dl.dropboxusercontent.com/s/wfkcgdi48hqhda4/firstfour.m4a', duration=13800))
