...
def handle_message(event):
    ...
    if event.message.text == "Help":
        ...
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://github.com/D0580754/hakka/blob/master/abafcb0e-e190-ce77-6964-625a915d20fc.mp4', duration=100000))
