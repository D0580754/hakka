...
def handle_message(event):
    ...
    if event.message.text == "Help":
        ...
        line_bot_api.push_message(uid, AudioSendMessage('https://dl.dropbox.com/s/e5l9v57q88ib8mz/firstsea.m4a', duration=13800))
        line_bot_api.reply_message(event.reply_token, AudioSendMessage(original_content_url='https://dl.dropbox.com/s/wfkcgdi48hqhda4/firstfour.m4a', duration=13800))
    elif event.message.text == "複診":
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text='櫃檯：第一次來嗎？\n櫃檯：第一擺來係無？\n病人：不是，之前來過了。\n病人：毋係，以前有來過。\n櫃檯：麻煩給我您的健保卡。\n櫃檯：麻煩分??你?健保卡。\n病人：好的，在這裡。\n病人：好，在這裡位。'))
        line_bot_api.push_message(uid, AudioSendMessage('https://dl.dropbox.com/s/gju0mm0e26ublff/backsea.m4a', duration=13800))
        line_bot_api.reply_message(event.reply_token, AudioSendMessage(original_content_url='https://dl.dropbox.com/s/3kdfgl104issg1g/backfour.m4a', duration=13800))
